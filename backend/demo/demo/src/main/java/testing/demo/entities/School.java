...
public class School implements Serializable {
    @Id
<<<<<<< HEAD:backend/demo/demo/src/main/java/testing/demo/model/School.java
...
=======
    ...
    @Column()
    private int id;
>>>>>>> db9abb4a47de7be7c0cc363c5cf5ab39f622ccc7:backend/demo/demo/src/main/java/testing/demo/entities/School.java
